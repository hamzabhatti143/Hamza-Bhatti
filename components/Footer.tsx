      ...
      <div className="py-8 px-6 md:px-10 border-t border-stone-100 dark:border-ink-900">
        <div className="max-w-6xl mx-auto flex flex-col sm:flex-row items-center justify-between gap-6">
          <div className="flex flex-col sm:flex-row items-center gap-3 sm:gap-6">
            <p className="font-mono text-xs text-stone-500 dark:text-ink-400 text-center sm:text-left">
              &copy; {year}{" "}
              <span className="text-stone-600 dark:text-ink-300">{personalInfo.name}</span>
              {" "}— Built with Next.js & Tailwind CSS
            </p>
            <a
              href="/admin"
              className="font-mono text-[10px] text-stone-500 dark:text-ink-400 hover:text-accent dark:hover:text-accent transition-colors duration-300"
            ...
            <a
              ...
              className="inline-flex items-center gap-1.5 font-mono text-xs text-stone-500 dark:text-ink-400 hover:text-[#25D366] transition-colors duration-300"
            >
